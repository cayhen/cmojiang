...
export function LogoTitle() {
  ...
  return (
    <div>
      ...
      {/* Info text — fades in below the heading */}
        ...
        <div style={{
          ...
          {activeData?.href ? (
            <a
              ...
              className="text-[#555] text-xs tracking-[0.04em] hover:text-[#777] transition-colors"
            >
              {activeData.value}
            </a>
          ) : (
            <span className="text-[#555] text-xs tracking-[0.04em]">{activeData?.value}</span>
          )}
        </div>
      </div>
